export class ChartDB {
  ...
  public static analyticsSession = {
    chart: {
      type: 'line',
      height: 30,
      sparkline: {
  ...
  public static analyticsPageView = {
    chart: {
      type: 'line',
      height: 30,
      sparkline: {
  ...
  public static analyticsPageSession = {
    chart: {
      type: 'line',
      height: 30,
      sparkline: {
  ...
  public static analyticsAvgSession = {
    chart: {
      type: 'line',
      height: 30,
      sparkline: {
  ...
  public static analyticsBounceRate = {
    chart: {
      type: 'line',
      height: 30,
      sparkline: {
  ...
  public static saleAnnualProfit = {
    chart: {
      height: 350,
      type: 'line',
      stacked: false,
  ...
  public static saleSatisfaction = {
    chart: {
      height: 260,
      type: 'pie',
    },
  ...
  public static chartUniqueVisitor = {
    chart: {
      type: 'bar',
      height: 220,
      zoom: {
  ...
  public static chartProcessCompliance = {
    chart: {
      height: 200,
      type: 'bar',
      sparkline: {
